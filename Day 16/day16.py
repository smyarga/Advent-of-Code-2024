...
if __name__ == '__main__':
    ...
    best_score1 = move(*input_test1)
    best_score2 = move(*input_test2)
    print('Task on test1:', best_score1)
    print('Task on test2:', best_score2)
    best_score_real = move(*input_real)
    print('Task on input:', best_score_real)